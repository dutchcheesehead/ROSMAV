...
vector<map_loader::Node> previous;
vector<int> erased;

void Dijkstras(map_loader::GraphMap gmap, position_tracker::Position init_pos, position_tracker::Position dst_pos);
vector<int> AdjacentRemainingNodes(map_loader::Node node);
Node ExtractSmallest(vector<map_loader::Node>& nodes);
