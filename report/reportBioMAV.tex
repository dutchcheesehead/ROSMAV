...
The behaviour of the drone is based on the heatmap described in section xxxx. 
Given our array of activations for our goal color the average location of this color is determined using this formula: \\
\\
\\
INSTERT FORMULA\\
\\
