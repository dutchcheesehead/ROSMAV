...
The first BioMAV project started in xxxxxx with an enthousiastic group of people.
After the initial project was a large succes and obtained the third price in the imav competition on xxxxxinsert datexxxx a second project was started.
...
The task of the "image processing" team was defined as getting useful features from the image data, which would be given to the "drone control" group.
...
One of the wishes of the group was a code implementation using ROS.
This was another software part that both teams had to figure out how to use. 
...
Unfortunately this did not solve our problem about recognizing other objects as target objects. % Dit is nog een vage zin...
