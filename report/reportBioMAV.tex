...
2. Install ROS (we used electric) by following this guide: http://www.ros.org/wiki/electric/Installation/Ubuntu

3. make sure that you performed the “Environment setup” step during installation.

4. Download our repository from
https://github.com/dutchcheesehead/ROSMAV

5. Navigate to ROSMAV/brown-ros-pkg-read-only/experimental

6. Remove the old cmake\_cache file if it exists
If it doesn't exist, continue.

7. In the terminal, run: cmake . (note that the dot is very important)

7.5 Navigate to the folder where you checked out the ros\_package. In our case this was:ROSMAV/brown-ros-pkg-read-only/experimental/ardrone\_brown

7.6 Now run the command ./build\_sdk.sh

8. Use the command sudo rosmake or sudo make

9. Run the command roscore

10. In a different terminal, run rosrun ardrone\_brown ardrone\_driver This driver is able to receive messages from the ardrone.

11. Navigate to this folder:
ROSMAV/brown-ros-pkg-read-only/experimental/drone\_teleop/bin

12. In this folder, type ./teleop.py

13. Edit your ~.bashrc by typing nano .bashrc then put this at the end of your file: export ROS\_PACKAGE\_PATH=/home/\$USER/workspace/ROSMAV/cmvision:/home/\$USER/workspace/ROSMAV/brown-ros-pkg-read-only/experimental:/home/\$USER/workspace/ROSMAV:/home/\$USER/workspace/ROSMAV/stacks:\$ROS\_PACKAGE\_PATH

15. Navigate to the cmvision folder.

16.5 run cmake . In this folder

16. rosmake cmvision

17. add the “sluis” folder

18. change your rospackage path to make sure this folder is added

19. edit the blobs.launch file in cmvision to make sure the directory is right.


To start our software, run:
- Start roscore (roscore)
- Start de AR-drone (rosrun ardrone\_brown ardrone\_driver)
- Start de sluis (rosrun sluis sluis.py)
- Start cmvision met roslaunch cmvision blobs.launch (start this from the cmvision folder???)
- Start with rosrun ROSMAV v.py
